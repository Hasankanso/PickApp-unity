...
device registration, confirmation email, push notifications, alertBusiness(need pus notification only), logout by push notification, confirm email, delete user(delete rates and update ride seats), chatting system, native ads,delete user<br>
