...
public abstract class Panel : MonoBehaviour, IEquatable<Panel>
{
  ...
  public static UnityEvent spinnerOpenEvent;
  public static UnityEvent spinnerCloseEvent;

  void Awake()
  {
    if (spinnerOpenEvent == null)
      spinnerOpenEvent = new UnityEvent();
    spinnerOpenEvent.AddListener(OpenSpinner);
    if (spinnerCloseEvent == null)
      spinnerCloseEvent = new UnityEvent();
    spinnerCloseEvent.AddListener(CloseSpinner);
  }
