...
public class Driver : Person {
    ...
    public Driver(Person person, List<Car> cars, List<ScheduleRide> schedules) : base(person.Id, person.FirstName, person.LastName, person.Chattiness, person.Phone, person.UserPhone, person.Email, person.CountryInformations, person.Bio, person.Gender, person.Birthday, person.ProfilePictureUrl) {
        this.cars = cars;
        this.schedules = schedules;
        IsDriver = true;
    }
    public Driver(Person person, List<Car> cars) : base(person.Id, person.FirstName, person.LastName, person.Chattiness, person.Phone, person.UserPhone, person.Email, person.CountryInformations, person.Bio, person.Gender, person.Birthday, person.ProfilePictureUrl) {
        this.cars = cars;
        IsDriver = true;
    }
