...
public class Ride {
    ...
    public static Ride ToObject(JObject json) {
        ...
        //DateTime leavingDate = DateTime.ParseExact(json[nameof(Ride.leavingDate)].ToString(), "MM/dd/yyy HH:mm", CultureInfo.InvariantCulture);
        //Car car = Car.ToObject((JObject) json[nameof(Ride.car)]);
        ...
        rideJ[nameof(this.Map)] = this.MapBase64;
        */
        return new Ride(id, from, to, DateTime.Now, musicAllowed, acAllowed, smokingAllowed, petsAllowed,
